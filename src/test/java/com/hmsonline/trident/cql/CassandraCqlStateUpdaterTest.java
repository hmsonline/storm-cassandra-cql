...
public class CassandraCqlStateUpdaterTest extends TestCase {
	...
	public void testTuplesPropagation() throws Exception {
		...
		CassandraCqlStateUpdater<String, String> stateUpdaterNoTuplesPropagation = new CassandraCqlStateUpdater<String, String>(
				new MockCqlTupleMapper());
		...
		CassandraCqlStateUpdater<String, String> stateUpdaterTuplesPropagation = new CassandraCqlStateUpdater<String, String>(
				new MockCqlTupleMapper(), true);
	...
	private List<TridentTuple> getTridentTuples() {
		...
		List<Object> mockValueList = new ArrayList<Object>();
		mockValueList.add("testField");
		TridentTuple tuple = new TridentTupleView.FreshOutputFactory(new Fields("testField")).create(mockValueList);
		tuples.add(tuple);
		return tuples;
	}
